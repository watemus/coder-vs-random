...
uses
  Classes, SysUtils, FileUtil, DividerBevel, Forms,
...
begin
  ...
  begin
    ...
    if(EvilArray.arr[i].posX = 0)then
    begin
      FormMain.OnCreate(FormMain);
      exit();
    end;
...
begin
  ...
  map.sizeY := StrToInt(spinSize.caption);
